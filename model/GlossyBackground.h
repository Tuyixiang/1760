...
#ifndef INC_1760_GLOSSYBACKGROUND_H
#define INC_1760_GLOSSYBACKGROUND_H
...
class GlossyBackground : public Body {
...
public:
  ...
  const QString className() override {
    return QString("GlossyBackground");
  }

#endif

  GlossyBackground(const Scene* parent, int id) : Body(parent, id) {}

  ~GlossyBackground() override;
...
#endif //INC_1760_GLOSSYBACKGROUND_H
